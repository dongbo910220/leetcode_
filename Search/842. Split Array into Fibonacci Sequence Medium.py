...
Success
Details 
Runtime: 588 ms, faster than 11.77% of Python online submissions for Split Array into Fibonacci Sequence.
Memory Usage: 16.2 MB, less than 5.56% of Python online submissions for Split Array into Fibonacci Sequence.'''